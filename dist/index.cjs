...
const chatgptApi = require('@waylaidwanderer/chatgpt-api');

function _interopDefaultCompat (e) { return e && typeof e === 'object' && 'default' in e ? e.default : e; }

const qrcodeTerminal__default = /*#__PURE__*/_interopDefaultCompat(qrcodeTerminal);
...
class ChatGPT {
  constructor() {
    this.chatGPT = new chatgptApi.ChatGPTClient(
...
function onScan(qrcode) {
  qrcodeTerminal__default.generate(qrcode, { small: true });
